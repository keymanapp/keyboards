...
<p>The spelling of questioning word [tim˧˥] is "tỉm".</p>
 ...
 <p>If a [ji] sound syllable has forth, fifth, or sixth tone, it should be spelled as "yi", such as 「移yì」「以yĩ」「易yị」</p>
...
<p>If one syllable was historically evolved from the merging of two syllables, an apostrophe can be inserted between the front consonant and the vowel. For example, "mât-dẽ乜嘢" evolved to "m’e咩" "dị-sập二十" evolved "d’ạ廿" "sam-sập三十" evolved to "s’a卅" "m̀-hệ唔係" evolved to "m’ệ咪" </p>
