...
?>
<p>
    hoisan for Hòi Sán Vạ Koc Ngũi Tụ (Hoisanese). hoisan台山話國語字
<p>

   <p> 台山話國語字係一種羅馬化嘅粵語文字 <p>
      <p> Hòi Sán Vạ Koc Ngũi Tụ hại yât chủng Lò-Mã phá ké Oạt Ngũi mần tụ. <p>
<p>
...
<a href="https://github.com/Cathaylaboratory/quokyuzi/blob/main/quocnguytihoisanva.dict.yaml">台山話國語字字典dictionary for Hoisanese Koc Ngũy Tụ</a>

<!-- <p>See <a href="file:taigi_poj.pdf">this document</a> for all the key combinations.</p> -->


<p>範文：南國山河 Nàm Koc Sán Hò<p>
<p>南國山河南帝居 Nàm Koc Sán Hò Nàm Ái Kúi<p>
