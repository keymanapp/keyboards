...
<head>
  ...
  <title>Korean Morse Keyboard Help</title>
  <link rel="stylesheet" href="style.css" type="text/css" />
</head>
<body>
   <h1>Korean Morse Keyboard Help</h1>
   <div id='overview'>
    <h2>Overview</h2>
    <p>The Korean Morse keyboard is built to type Korean using the Morse transliteration system, also called SKATS (Standard Korean Alphabet Transliteration System). The Morse system is designed to make Latin-Korean transliteration 100% unambiguous.</p>
    ...
    <p>The Korean Morse keyboard creates hangeul syllables from jamo each time you press <kbd>Spacebar</kbd>.</p>
  ...
  <div id='layout'>
   <h2>Keyboard Layout</h2>
    <h3 style="clear:left">Korean Morse Keyboard</h3>
    ...
    <p>The Korean Morse keyboard converts Korean jamo into hangeul after you press <kbd>Spacebar</kbd>. As you type, Korean jamo are shown.
