...
<link rel="stylesheet" href="style.css" type="text/css" />
   ...
   <div id='overview'>
    <h2>Overview</h2>
    <p>The Korean KORDA keyboards are built to type Korean using the transliteration system KORDA (Korean Romanization for Data Application). KORDA is designed to make Latin-Korean transliteration easy, accurate, and computerizable. For more information on KORDA, see <a href='About KORDA.pdf'>About KORDA</a>, included with this package in the Windows Start Menu.</p>
    <p>The Korean KORDA keyboards create hangeul syllables from jamo or latin letters each time you press <kbd>Spacebar</kbd>.</p>
