...
*/
  $pagename = 'Inuktitut/Inuvialuktun Syllabics Keyboard Help';
    ...
    <table width="100%" border="0" cellspacing="10" cellpadding="10">
      <tr>
        <td colspan="3" valign="top">
          ...
          <p>Thank-you for using this free Languagegeek product. If you have any installation problems or other questions, please contact Chris Harvey at info@languagegeek.com.</p>
        </td>
        <td valign="top">
          <p>Several Syllabics fonts have been installed automatically on your computer.</p>
          <ul>
            <li type="disc">Aboriginal Sans
            <li type="disc">Masinahikan
            <li type="disc">Oski<li type="disc">Kayases<li type="disc">Kisiska
            </ul>
          <p>More syllabics fonts can be found at <a href="http://www.languagegeek.com/font/fontdownload.html">Languagegeek.com’s main font download page</a>.</p>
        </td>
      </tr>
      </table>
    <p></p>
