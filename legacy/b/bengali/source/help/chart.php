...
<table border=0 cellspacing=2 cellpadding=1>
	...
	<tr class='keymanweb' style='text-align:center; font-weight:normal; background-color:#ffffff'>
		...
		<td><span class='lang2' >১</span><br/><span class='keys'>[CA1]</span></td>
		<td><span class='lang2' >২</span><br/><span class='keys'>[CA2]</span></td>
		<td><span class='lang2' >৩</span><br/><span class='keys'>[CA3]</span></td>
		<td><span class='lang2' >৪</span><br/><span class='keys'>[CA4]</span></td>
		<td><span class='lang2' >৫</span><br/><span class='keys'>[CA5]</span></td>
		<td><span class='lang2' >৬</span><br/><span class='keys'>[CA6]</span></td>
		<td><span class='lang2' >৭</span><br/><span class='keys'>[CA7]</span></td>
		<td><span class='lang2' >৮</span><br/><span class='keys'>[CA8]</span></td>
		<td><span class='lang2' >৯</span><br/><span class='keys'>[CA9]</span></td>
		<td><span class='lang2' >০</span><br/><span class='keys'>[CA0]</span></td>
	</tr>
	...
	<tr style='text-align:center; font-weight:normal; background-color:#ffffff'>
		...
		<td><span class='lang2' >ৗ</span><br/><span class='keys'>[CAq]</span></td>
		<td><span class='lang2' >ৣ</span><br/><span class='keys'>[CAr]</span></td>
		<td><span class='lang2' >ৢ</span><br/><span class='keys'>[CA=]</span></td>
		<td><span class='lang2' >৴</span><br/><span class='keys'>[CAa]</span></td>
		<td><span class='lang2' >৶</span><br/><span class='keys'>[CAs]</span></td>
		<td><span class='lang2' >৸</span><br/><span class='keys'>[CAd]</span></td>
		<td><span class='lang2' >ৢ</span><br/><span class='keys'>[CAf]</span></td>
		<td><span class='lang2' >ৰ</span><br/><span class='keys'>[CAj]</span></td>
	</tr>
	<tr style='text-align:center; font-weight:normal; background-color:#ffffff'>
		<td style='text-align:left; font-weight:bold; background-color:#dedede' valign=top> </td>
		<td><span class='lang2' >ৠ</span><br/><span class='keys'>[CA+]</span></td>
		<td><span class='lang2' >ৡ</span><br/><span class='keys'>[CAR]</span></td>
		<td><span class='lang2' >৵</span><br/><span class='keys'>[CAA]</span></td>
		<td><span class='lang2' >৷</span><br/><span class='keys'>[CAS]</span></td>
		<td><span class='lang2' >৹</span><br/><span class='keys'>[CAD]</span></td>
		<td><span class='lang2' >ঌ</span><br/><span class='keys'>[CAF]</span></td>
		<td><span class='lang2' >ৱ</span><br/><span class='keys'>[CAJ]</span></td>
...
<div id="Back">
<p><a href="bengali.php">Back to Traditional Bengali Keyboard Help</a><br/>
</p>
</div>
