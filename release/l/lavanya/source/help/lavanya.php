<?php
// Set page title
$pageTitle = "Lavanya Documentation";
...
<head>
    ...
    <style>
        body {
            font-family: nirmala-ui, vani, 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            line-height: 1.6;
            color: #333;
            max-width: 1000px;
            margin: 0 auto;
...
<body>
    <h1>Telugu Keyman Keyboard Documentation</h1>
    ...
    <footer>
        <p>Last updated: <?php echo $currentDate; ?></p>
        <p>Generated by: <?php echo $_SERVER['SERVER_NAME']; ?></p>
    </footer>
</body>
</html>
