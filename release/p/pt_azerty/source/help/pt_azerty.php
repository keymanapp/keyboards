<?php 
  $pagename = 'Portuguese Azerty Keyboard Help';
  $pagetitle = $pagename;
...
<p>
    This keyboard layout is based on Azerty and designed for Portuguese.  It includes an on screen keyboard which can be viewed by clicking on the Keyman icon and selecting the On Screen Keyboard menu item.
</p>
