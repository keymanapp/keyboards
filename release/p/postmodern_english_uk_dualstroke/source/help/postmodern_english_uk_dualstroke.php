<?php
	$pagename = 'Postmodern English UK DualStroke Layout Help';
	$pagetitle = $pagename;
	// Header
	require_once('header.php');
?>

<h1>Start Using the Postmodern English UK DualStroke Layout</h1>
...
<p>
	...
	British English keyboard, most keys only need one press to print out a character to the 
	screen.
	<br /><br />
	<img src = "pme_uk_dualstroke_desktop_keyboard.png" alt = "Postmodern English US DualStroke Style Desktop">
	<br /><br />
