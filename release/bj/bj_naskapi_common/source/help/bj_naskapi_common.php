...
?>
  ...
  <p>Keyboard Copyright (c) 2001-2020 Bill Jancewicz</p>
  <section id='overview'>
	<h2>Overview</h2>
	<p>The Naskapi (Common) keyboard is a phonetic-style (type the word the way it sounds) layout. It uses Unified Canadian Aboriginal Syllabics.</a>.</p>
