...
<ol>
  <li><b>Using Keyman Configuration</b>: On Windows or Linux, go to <b>Keyman → Configuration → Keyboard Layouts → Swampy Cree (Tataskweyak) → Keyboard Options</b> and choose <b>Decomposed</b>. 
  You will need to close and reopen your input application, keyboard, and possibly Keyman application before the default behavior changes. This method will change your default to <i>Decomposed</i> and 
