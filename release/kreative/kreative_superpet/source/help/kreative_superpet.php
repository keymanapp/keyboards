...
<p>
	<b>Now works fully on Windows!</b><br>
	You will need to uninstall the old version first.<br>
	Then, download and install <a href="https://keyman.com/windows/download#standalone" target="_blank">Keyman Desktop</a>.<br>
	Finally, open and install <code>SuperPET.kmx</code> from the <code>Keyman</code> directory.
</p>
