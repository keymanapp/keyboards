...
<ul>
    <li>All accents are typed after the base character — ŝ is typed <kbd>s</kbd> then Left-bracket <kbd>[</kbd>
        <ul>
            <li>To type the acute accent ˊ use either the Slash key <kbd>/</kbd> or Backquote key <kbd>`</kbd> — á is
                typed <kbd>a</kbd> then <kbd>/</kbd> or <kbd>a</kbd> then <kbd>`</kbd></li>
            <li>To type the circumflex accent ˆ use the Left-bracket key <kbd>[</kbd> — ŝ is typed <kbd>s</kbd> then
                <kbd>[</kbd>
            </li>
        </ul>
    </li>
    <li>You can type the English value of the punctuation keys by holding down the Right-Alt or Option key. The
        Semicolon ; is typed <kbd>Right-Alt</kbd>+<kbd>;</kbd> (Windows) / <kbd>⌥ Option</kbd>+<kbd>;</kbd> (Mac).
        <ul>
            <li>NOTE: When using Google Docs, Slash / is typed <kbd>Right-Alt</kbd>+<kbd>Shift</kbd>+<kbd>/</kbd>
                (Windows) / <kbd>⌥ Option</kbd>+<kbd>Shift</kbd>+<kbd>/</kbd></li>
        </ul>
    </li>
...
<div id='wikitext'>
    ...
    <table border='1' style='border-collapse:collapse' cellpadding='5'>
        <tr>
            ...
            <td align='center'>w ŵ</td>
            <td align='center'>e é</td>
            <td align='center'>ɨ ɨ́</td>
