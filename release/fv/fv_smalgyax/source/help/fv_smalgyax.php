...
<ul>
	<li>All accents are typed after the base character — a̱ is typed <kbd>a</kbd> then Semicolon <kbd>;</kbd>
		<ul>
			<li>To type the underline accent use the Semicolon key ; — ḵ is typed <kbd>k</kbd> then Semicolon
				<kbd>;</kbd></li>
		</ul>
	</li>
	<li>All changed punctuation can type their original value by holding down the Right-Alt or Option key. The Semicolon
		...
		<ul>
			<li>NOTE: When using Google Docs, Slash / is typed <kbd>Shift</kbd>+<kbd>Right-Alt</kbd>+<kbd>/</kbd>
				(Windows) or <kbd>Shift</kbd>+<kbd>⌥ Option</kbd>+<kbd>/</kbd> (Mac)</li>
		</ul>
	</li>
	<li>Opening and closing quotes. For Mac users, Right-Alt is either of the Option Keys.
		<ul>
			...
			<li>double « <kbd>Right-Alt</kbd>+<kbd>9</kbd> — » <kbd>Right-Alt</kbd>+<kbd>9</kbd></li>
		</ul>
	</li>
	<h2>Unicode Fonts</h2>
