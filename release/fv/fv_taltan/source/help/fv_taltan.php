...
<ul>
	<li>All accents are typed after the base character — ā is typed <kbd>a</kbd> then Slash <kbd>/</kbd>
		<ul>
			<li>To type the macron accent ̄ use the Slash key <kbd>/</kbd> — ē is typed <kbd>e</kbd> then
				<kbd>/</kbd>
			</li>
			<li>To type the underline accent _ use the Left-bracket key <kbd>[</kbd> — s̱ is typed <kbd>s</kbd> then
				Left-bracket <kbd>[</kbd></li>
		</ul>
	</li>
	<li>You can type the English value of the punctuation keys by holding down the Right-Alt or Option key. The
		Slash / is typed <kbd>Right-Alt</kbd>+<kbd>/</kbd> (Windows) / <kbd>⌥ Option</kbd>+<kbd>/</kbd> (Mac).</li>
	<ul>
		<li><b>NOTE:</b> When using Google Docs, Slash / is typed <kbd>Right-Alt</kbd>+<kbd>Shift</kbd>+<kbd>/</kbd>
			(Windows) / <kbd>⌥ Option</kbd>+<kbd>Shift</kbd>+<kbd>/</kbd> (Mac)</li>
	</ul>
	<li>Opening and closing quotes. For Mac users, Right-Alt is either of the Option Keys.</li>
	<ul>
		<li>single: ‘ <kbd>`</kbd> — ’ <kbd>'</kbd></li>
		<li>
			double: “ <kbd>Shift</kbd>+<kbd>[</kbd> — ” <kbd>Shift</kbd>+<kbd>]</kbd></li>
		<li>
			single: ‹ <kbd>Right-Alt</kbd>+<kbd>Shift</kbd>+<kbd>9</kbd> — ›
			<kbd>Right-Alt</kbd>+<kbd>Shift</kbd>+<kbd>0</kbd></li>
		<li>
			double: « <kbd>Right-Alt</kbd>+<kbd>9</kbd> — » <kbd>Right-Alt</kbd>+<kbd>0</kbd></li>
	</ul>
</ul>
...
<div id='wikitext'>
	...
	<table border='1' style='border-collapse:collapse' cellpadding='5'>
		<tr>
			...
			<td align='center'>e ē</td>
			<th align='center'>¯</th>
			<td align='center'>t</td>
			<td align='center'>y</td>
			<td align='center'>u ū</td>
			<td align='center'>i ī</td>
			<td align='center'>o ō</td>
			<td align='center'>p</td>
		</tr>
		<tr>
			<td align='center'>a ā</td>
			<td align='center'>s s̱</td>
