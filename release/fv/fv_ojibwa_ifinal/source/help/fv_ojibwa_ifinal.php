<?php 
  $pagename = 'ᐊᓂᔑᓇᐯᒧᐎᣙ (Ojibwa, i-finals, left w-dot) Help';
  $pagetitle = 'ᐊᓂᔑᓇᐯᒧᐎᣙ (Ojibwa, i-finals, left w-dot) Help';
  $pagestyle = <<<END
...
This keyboard is designed for the <b>ᓂᔑᓇᐯᒧᐎᣙ</b> language of the Eastern Subarctic region of Canada.
</p>
...
<ul>
	...
	<li>The syllabics used to write ᐊᓂᔑᓇᐯᒧᐎᣙ (Ojibwa) are typed primarily by writing their long-vowel equivalents, with a few exceptions. See <a href=ojibwa_ifinals.pdf>this document</a> for a full list of how to type each syllable with this keyboard, and all of the special key combinations.</li>
		<ul>
