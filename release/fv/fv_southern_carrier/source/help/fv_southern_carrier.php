...
<ul>
    <li>The on-screen keyboard shows each syllable in their final form (where applicable) and in their a-orientation (consonants) or their full form (vowels).</li>
	<li>The ᑐᑊᘁᗕᑋᗸ (Dakelh / Dulk'wah ke) keyboard is a "build-a-syllable" keyboard. The syllabics are typed phonetically by entering their Latin equivalents. The syllabics are typed by entering their Latin equivalents. See <a href="fv_SouthernCarrierGuide.pdf">this document</a> for all the special key combinations.</li>
    <li>By typing a single consonant or a key that's assigned to a consonant, the syllable final form will appear on screen. Following the consonant with a vowel will change the syllable final into sits full form in the orientation corresponding with the vowel typed.
        <ul>
            <li>Typing the <kbd>m</kbd> key outputs <b>ᒼ</b>. If the <kbd>a</kbd> key is typed after, it will change to <b>ᘍ</b></li>
            <li>There are some exceptions to this. The <kbd>c</kbd>, <kbd>w</kbd>, <kbd>j</kbd> and <kbd>y</kbd> keys will output the full syllable in the a-orientation. Following the syllable with a vowel key will change it into the corresponding orientation.
                <ul>
...
<li>The initial a form of a syllable that is typed when tapping on the base key will be replaced by the selected orientation.</li> 
                    
<li>If there is an associated final, it will appear above the Backspace key when the "a" orientation of a syllabic is selected.</li>
    <ul>
...
<ul>
    <li>You can return to the default layer by tapping on either <b>|</b> or <b>〈</b>. On your mobile device, these will have green text. </li>
    <li>The first character in a cell is the "one-tap" key, any further characters are "hold-select" keys.</li>
</ul>
