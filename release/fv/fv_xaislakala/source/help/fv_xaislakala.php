<?php 
  $pagename = 'X̄aʼislak̓ala Keyboard Help';
  $pagetitle = 'X̄aʼislak̓ala Keyboard Help';
  $pagestyle = <<<END
...
<p style='margin: 16px 0 0 0'>
    This keyboard is designed for the <b>X̄aʼislak̓ala</b> language of the BC Coast region of Canada.
</p>
...
<img src="Haisla.png" alt="" height="198" width="514" border="0" /></h2>
<ul>
    <li>All accents are typed after the base character — k̓ is typed <kbd>k</kbd> then <kbd>/</kbd>
        <ul>
            <li>To type the apostrophe accent use the Slash key <kbd>/</kbd> — p̓ is typed <kbd>p</kbd> then
                <kbd>/</kbd>
            </li>
            <li>To type the macron accent use the Left-Bracket key <kbd>[</kbd> — ḡ is typed <kbd>g</kbd> then
                <kbd>[</kbd>
            </li>
            <li>X̄aʼislak̓ala uses three different kinds of apostrophes:
                <ul>
                    <li>Curly Apostophe ’ — on the Apostrophe key <kbd>'</kbd></li>
                    <li>Straight Apostrophe ' — on the Right-Bracket key <kbd>]</kbd></li>
                    <li>Apostrophe accent ’ — on the Slash key <kbd>/</kbd></li>
                </ul>
            </li>
        </ul>
    </li>
    <li>The original English punctuation keys can be typed by holding down the Right-Alt or Option key — the Semicolon ;
        is typed <kbd>Right-Alt</kbd>+<kbd>;</kbd> (Windows) / <kbd>⌥ Option</kbd>+<kbd>;</kbd> (Mac).
        <ul>
            <li>NOTE: When using Google Docs, Slash / is typed <kbd>Shift</kbd>+<kbd>Right-Alt</kbd>+<kbd>/</kbd>
                (Windows) / <kbd>Shift</kbd>+<kbd>⌥ Option</kbd>+<kbd>/</kbd> (Mac)
        </ul>
    </li>
    </li>
...
<h2>Downloads</h2>
<h3><a href="https://www.languagegeek.com/nwc/keymaps/WakashanCanada/Haisla.pdf">Download a pdf of the Keylayout Map</a>
</h3>
...
<div id='wikitext'>
    ...
    <table border='1' style='border-collapse:collapse' cellpadding='5'>
        ...
        <tr>
            ...
            <td align='center'>g ḡ</td>
            <td align='center'>h</td>
            <td align='center'>ᵒ</td>
            <td align='center'>k k̓</td>
            <td align='left'>l l̓</td>
            <td align='center'>' "</td>
        </tr>
        <tr>
            <td align='center'>⇧</td>
