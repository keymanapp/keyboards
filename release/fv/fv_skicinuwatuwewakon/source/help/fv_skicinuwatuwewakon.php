<?php 
  $pagename = 'Skicinuwatuwewakon Keyboard Help';
  $pagetitle = 'Skicinuwatuwewakon Keyboard Help';
  $pagestyle = <<<END
...
This keyboard is designed for the <b>Skicinuwatuwewakon</b> language of the Atlantic region of Canada.
</p>
