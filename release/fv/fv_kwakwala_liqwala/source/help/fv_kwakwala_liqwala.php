...
<ul>
    <li>The special characters of Kʷak̓ʷala have been assigned to the number keys. To type the numerals, hold down the
    ...
    <li>To type the apostrophe accent use the Apostrophe key <kbd>'</kbd> — k̓ is typed <kbd>k</kbd> then <kbd>'</kbd>
    </li>
    <li>The original values of the punctuation keys can be typed by holding down the Right-Alt or Option key — the
		...
		<ul>
			<li>NOTE: When using Google Docs, Slash / is typed <kbd>Right-Alt</kbd>+<kbd>Shift</kbd>+<kbd>/</kbd> (Windows) / <kbd>⌥ Option</kbd>+<kbd>Shift</kbd>+<kbd>/</kbd> (Mac)</li>
    <li>Opening and closing quotes. For Mac users, Right-Alt is either of the Option Keys.
        <ul>
            <li>single: ‘ <kbd>[</kbd> — ’ <kbd>]</kbd></li>
            <li>double: “ <kbd>Shift</kbd>+<kbd>Left-Bracket</kbd> — ” <kbd>Shift</kbd>+<kbd>Right-Bracket</kbd></li>
...
<div id='wikitext'>
    ...
    <table border='1' style='border-collapse:collapse' cellpadding='5'>
        ...
        <tr>
            ...
            <td align='center'>d dᶻ</td>
            <td align='center'>ʔ</td>
            <td align='center'>g ǧ</td>
