<?php
$pagename = 'Dɛnɛsųłinɛ Keyboard Help';
$pagetitle = 'Dɛnɛsųłinɛ Keyboard Help';
$pagestyle = <<<END
...
<p style='margin: 16px 0 0 0'>
	This keyboard is designed for the <b>Dɛnɛsųłinɛ</b> language of the Western Subarctic region of Canada.
</p>
...
<ul>
	...
	<li>You can type the original English punctuation by holding down the Right-Alt or Option key. The Semicolon ; is
		typed Right-Alt+Semicolon (Windows) Option+Semicolon (Mac).</li>
	...
	<div id='wikitext'>
		...
		<table border='1' style='border-collapse:collapse' cellpadding='5'>
			<tr>
				...
				<td align='center'>e é ę ę́</td>
				<td align='center'>r</td>
				<td align='center'>t</td>
				<td align='center'>y</td>
				<td align='center'>u ú ų ų́</td>
				<td align='center'>i í į į́</td>
				<td align='center'>o ó ǫ ǫ́</td>
				<td align='center'>ł</td>
			</tr>
			<tr>
				<td align='center'>a á ą ą́</td>
				<td align='center'>s</td>
				<td align='center'>d</td>
				<td align='center'>ɛ ɛ́ ɛ̨ ɛ̨́</td>
