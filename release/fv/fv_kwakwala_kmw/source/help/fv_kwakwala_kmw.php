<?php 
  $pagename = 'Kwak̕wala Keyboard Help';
  $pagetitle = 'Kwak̕wala Keyboard Help';
  $pagestyle = <<<END
...
This keyboard is designed for the <b>Kwak̕wala</b> language of the BC Coast region of Canada.
</p>
<p>If square boxes are displayed instead of characters when using this keyboard (and in the keyboard layouts below), please read our <a href="/troubleshooting/#boxes">troubleshooting guide</a>.
</p>

<img src="UKwakwala.png" alt="" height="198" width="514" border="0" /></h2>
					<h2>Keyboard Layout </h2>
					<ul>
						<li>The special Characters of Kwak̕wala have been assigned to various punctuation keys</li>
						<li>All accents are typed after the base character: <strong>a̱</strong> is typed <strong>a</strong> then <strong>semicolon ;</strong></li>
						<li>To type the glottalized accent when it appears over a single letter use the <strong>slash key /</strong><br />
      ...
      single ‹ Right-Alt+Shift+9 — › Right-Alt+Shift+0 </li><li>
    ...
    <p>The following fonts have been installed on your computer: <strong>Aboriginal Sans, Aboriginal Serif.</strong> Please use these fonts when typing in your language as they have been specially built to represent your language as accurately as possible. </p><h2>Downloads</h2>
      <h3><a href="http://www.languagegeek.com/nwc/keymaps/WakashanCanada/Kwakwala.pdf">Download a pdf of the Kwak̕wala Keylayout Map</a></h3>
...
<table border='1' style='border-collapse:collapse' cellpadding='5' ><tr ><td  align='center'>a̱</td><td  align='center'>w</td><td  align='center'>e</td><td  align='center'>ł</td><td  align='center'>t t̓ t̕ł t̕s</td><td  align='center'>y</td><td  align='center'>u</td><td  align='center'>i</td><td  align='center'>o</td><td  align='center'>p p̓</td></tr>
<tr ><td  align='center'>a</td><td  align='center'>s</td><td  align='center'>d</td><td  align='center'>g̱</td><td  align='center'>g</td><td  align='center'>h</td><td  align='center'>ḵ ḵ̓ ḵ̕w</td><td  align='center'>k k̓ k̕w</td><td  align='center'>l</td><td  align='center'>' "</td></tr>
<tr ><td >&nbsp;</td><td  align='center'>z</td><td  align='center'>x</td><td  align='center'>x̱</td><th  align='center'>’</th><td  align='center'>b</td><td  align='center'>n</td><td  align='center'>m</td><td  colspan='2'>&nbsp;</td></tr>
</table>
