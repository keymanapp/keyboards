<?php 
  $pagename = 'Nsyilxcən Keyboard Help';
  $pagetitle = 'Nsyilxcən Keyboard Help';
  $pagestyle = <<<END
...
<ul>
    <li>The special characters of Nsyilxcən have been assigned to the number keys. To type the numerals, hold down the
        ...
        keyboards keep its original numbers</li>
    <li>All accents are typed after the base character — á is typed <kbd>a</kbd> then Semicolon <kbd>;</kbd>
        <ul>
            ...
            <li>To type the under-dot accent use the number 1 key <kbd>1</kbd> — x̣ is typed <kbd>x</kbd> then
                <kbd>1</kbd>
            </li>
            <li>To type the caron accent use the number 7 key <kbd>7</kbd> — x̌ is typed <kbd>x</kbd> then <kbd>7</kbd>
            </li>
...
<div id='wikitext'>
    ...
    <table border='1' style='border-collapse:collapse' cellpadding='5'>
        ...
        <tr>
            ...
            <td align='center'>s š</td>
            <td align='center'>ʔ</td>
            <th align='center'>´</th>
            <td align='center'>ɣ ɣ̓</td>
            <td align='center'>h ḥ</td>
        ...
        <tr>
            ...
            <td align='center'>x x̌ x̣</td>
            <td align='center'>c c̓ č č̓</td>
            <th align='center'>’</th>
