...
<ul>
	...
	<li>The syllabics used to write ᐊᓂᔑᓇᐯᒧᐎᓐ (Ojibwa) are typed primarily by writing their long-vowel equivalents, with a few exceptions. See <a href=Ojibwa.pdf>this document</a> for a full list of how to type each syllable with this keyboard, and all of the special key combinations.</li>
		<ul>
...
<ul>
	<li>keys with a red background are combining accents. On your phone, they will appear with green text.</li>
