...
<ul>
	...
	<li>The syllabics used to write ᐊᓂᔑᓇᐯᒧᐏᣙ (Ojibwa) are typed primarily by writing their long-vowel equivalents, with a few exceptions. See <a href=Ojibwa__ifinal_rdot.pdf>this document</a> for a full list of how to type each syllable with this keyboard, and all of the special key combinations.
		<ul>
			<li>By typing a single consonant or a key that's assigned to a consonant, the syllable final form will appear on screen. Following the consonant with a vowel will change the syllable final into its full form in the orientation corresponding with the vowel typed.</li>
				<ul>
					<li>Typing the k or g key outputs <b>ᣖ</b>. If the a key is typed after, it will change to ᑲ.</li>
				</ul>
			...
			<li>To add the w-dot, type the w after the first consonant</li>
				<ul>
					<li><b>ᐃᣖᐍ</b> is typed <be>ik[we</b> or <b>ig[we</b></li>
				</ul>
	...
	<li>In the case of a vowel immediately after a syllable final or two vowels that need to be side by side, use the <b>left bracket key [ </b> to keep the syllables separate
		<ul>
			<li><b>ᐊᒹᑲᓂᐏᣕ  ᐊᐊ</b> (pointed) is typed <b>amwaakaniwit a[a</b></li>
			<li><b>ᐊᒷᑲᓂᐏᣕ ᐊᐊ</b> (unpointed) is typed <b>amwakaniwit a[a</b></li>
			<li><b>ᐋᓃᣛ ᐁᣛᓂᑳᣚᔾᐃᣙ</b> (pointed) is typed <b>aaniiZ eZnikaazy[in</b> or <b>aaniiS eSnigaasy[in</b></li>
			<li><b>ᐊᓂᣛ ᐁᣛᓂᑲᣚᔾᐃᣙ</b> (unpointed) is typed <b>aniZ eZnikazy[in</b> or <b>aniS eSnigasy[in</b></li>
		</ul>
	</li>
	<p></p>
...
<h2>Unicode Fonts</h2>
						<p>The following fonts have been installed on your computer: <strong>Aboriginal Serif.</strong> Please use this font when typing in your language as it has been specially built to represent your language as accurately as possible. </p>
    <h3><a href="http://www.languagegeek.com/font/fontdownload.html">Download the latest version of Aboriginal Serif</a></h3>
