...
<ul>
    ...
    <li>The syllabics used to write ᐊᓂᔑᓇᐯᒧᐏᣙ (Ojibwa) are typed primarily by writing their long-vowel equivalents, with
        ...
        <ul>
            <li>By typing a single consonant or a key that's assigned to a consonant, the syllable final form will
                ...
                in the orientation corresponding with the vowel typed.</li>
            <ul>
    ...
    <li>The syllabics sets for sh- / zh- (ᔐᔑᔓᔕᔥ), ch- (ᒉᒋᒍᒐᒡ), and th- (ᕞᕠᕤᕦᕪ) are typed by SHIFT + the first letter of
        each sound (s, z, and t).
        <ul>
    ...
    <li>A standalone w-dot can be typed with the q key.
        <ul>
            <li><b>NOTE:</b> the dot indicating a long vowel and the w-dot do not need to be typed for the majority of
                ...
                character
                that contains the syllable and one or both dots, ie; ᕙᐧ.</li>
    </li>
</ul>
...
<li>All English letters can be typed by pressing <b>Right-Alt / Option </b> followed by the letter(s) you wish
    to type.</li>
<li>All uppercase English letters can be typed by pressing <b>Shift+Right-Alt / Option</b> followed by the
