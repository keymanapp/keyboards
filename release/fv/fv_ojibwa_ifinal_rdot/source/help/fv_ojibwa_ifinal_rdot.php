...
<ul>
	...
	<li>The syllabics used to write ᐊᓂᔑᓇᐯᒧᐏᣙ (Ojibwa) are typed primarily by writing their long-vowel equivalents, with a few exceptions. See <a href=Ojibwa__ifinal_rdot.pdf>this document</a> for a full list of how to type each syllable with this keyboard, and all of the special key combinations.</li>
		<ul>
...
<ul>
	<li>keys with a red background are combining accents. They will appear with green text on your mobile device.</li>
