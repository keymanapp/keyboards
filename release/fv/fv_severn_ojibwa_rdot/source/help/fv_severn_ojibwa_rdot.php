...
<ul>
	<li>The on-screen keyboard shows each syllable in their final form and in their e-orientation (consonants), or in their short and long form (vowels).</li>
	<li>The syllabics used to write ᐊᓂᔑᓂᓂᒧᐏᐣ (Severn Ojibwa) are typed primarily by writing their long-vowel equivalents, with a few exceptions. See <a href=severn_ojibwa_rdot.pdf>this document</a> for a full list of how to type each syllable with this keyboard, and all of the special key combinations.</li>
		<ul>
			...
			<li>To add the w-dot, type the w after the first consonant.
				<ul>
					<li><b>ᐃᐠᐍ</b> is typed <b>ik[we</b> or <b>ig[we</b></li>
				</ul>
			</li>
