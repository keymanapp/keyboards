<?php 
  ...
  $pagetitle = 'ᐊᓂᔑᓇᐯᒧᐏᓐ (Ojibwa, a-finals, right w-dot)bKeyboard Help';
  $pagestyle = <<<END
...
<ul>
	...
	<li>In the case of a vowel immediately after a syllable final or two vowels that need to be side by side, use the <b>left bracket key [ </b> to keep the syllables separate
		<ul>
			<li><b>ᐊᒹᑲᓂᑦ  ᐊᐊ</b> (pointed) is typed <b>amwaakaniwit a[a</b></li>
			<li><b>ᐊᒷᑲᓂᑦ ᐊᐊ</b> (unpointed) is typed <b>amwakaniwit a[a</b></li>
