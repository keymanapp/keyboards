...
<ul>
								<li>The syllabics used to write ᓀᐦᐃᔭᐍᐏᐣ (Plains Cree) are typed by entering their Standard Roman Orthography Equivalents.</li>
								<li><b>ᓀᐦᐃᔭᐍᐏᐣ</b> would be typed as 'nehiyawewin'</li>
								<li>In the case of syllables with multiple syllable finals, type the <b>left bracket key [ </b> to keep the syllables separate </li>
                  ...
                  <li>The regular left bracket is typed <b>Right-Alt+Left-Bracket</b></li>
								...
								<li>Quotation marks</li>
									<li>double guillemets: « Semicolon — » Period </li>
									<li>double: " Right-Alt+Semicolon — " Right-Alt+Period</li>
								</ul>
							 </ul>
