...
regular QWERTY keyboard and get Gujarati Unicode output.</p>
...
<p>The following table shows the English letters to type to get consonants with nuktas
for the <a href="https://r12a.github.io/scripts/gujarati/#extensions">transcription of Arabic and Avestan</a>.</p>
<table class="inputSequences" style="margin-left: auto; margin-right: auto;">
<tbody>
<tr>
<td>ક઼</td> <td>.ka</td> <td>|</td>
<td>ખ઼</td> <td>.kha</td> <td>|</td>
<td>ગ઼</td> <td>.ga</td> <td>|</td>
<td>ઘ઼</td> <td>.gha</td> <td>|</td>
<td>જ઼</td> <td>.ja</td> <td>|</td>
<td>ત઼</td> <td>.ta</td>
</tr>
</tbody>
</table>
...
<kbd>MM</kbd> (અઁ). These consonantal diacritics follow the vowel signs including the implicit ’a’. 
The following table shows consonant ’k’ followed by
various dependent vowel signs and consonantal diacritics ં <kbd>M</kbd>, ઃ <kbd>H</kbd> and ઁ <kbd>MM</kbd>.</p>
<table class="inputSequences" style="margin-left: auto; margin-right: auto;">
<thead>
<tr>
<th></th>
...
<samp>ક્ત્‌</samp>. The inherent <strong>a</strong> is only applied when followed by 
<kbd>space</kbd>. e.g. <kbd>k</kbd> <kbd>t</kbd> <kbd>a</kbd> or <kbd>k</kbd> <kbd>t</kbd> 
<kbd>space</kbd> produces <samp>ક્ત</samp>. To force an explicit virama at end of word, use 
...
<kbd>a</kbd> <kbd>_</kbd> <kbd>i</kbd> will generate <samp>અ‌ઇ</samp>,
<kbd>k</kbd> <kbd>_</kbd> <kbd>S</kbd> will generate <samp>ક્‌ષ</samp>
.</p>

<h3>Zero Width Joiner (ZWJ)</h3>
<p>To type a Zero Width Joiner, <kbd>+</kbd> can be typed between the letters, for example: 
<kbd>k</kbd> <kbd>+</kbd> <kbd>S</kbd> will generate <samp>ક્‍ષ</samp> while 
<kbd>k</kbd> <kbd>S</kbd> will generate <samp>ક્ષ</samp> .</p>
...
<tr> <td><kbd>,</kbd><kbd>,</kbd></td> <td><samp>૰</samp></td> <td>Gujarati Abbreviation Sign</td></tr>
...
<h3>Numbers</h3>
<ol>
<li>Press the number keys to type Gujarati digits. for example <kbd>9</kbd> produces 
<samp>૯</samp>.</li>
...
<tbody>
<tr><td><kbd>OM</kbd></td><td><samp>ૐ</samp></td><td>OM SIGN</td></tr>
<tr><td><kbd>#</kbd></td><td><samp>ૐ</samp></td><td>OM SIGN</td></tr>
<tr><td><kbd>$</kbd></td><td><samp>₹</samp></td><td>RUPEE SIGN</td></tr>
<tr><td><kbd>%</kbd></td><td><samp>રૂ૰</samp></td><td>GUJARATI RUPEE SIGN</td></tr>
...
<tr><td><kbd>V</kbd></td><td><samp>ઽ</samp></td><td>AVAGRAHA</td></tr>
</tbody>
</table>
