...
<p><img src="sil_eastern_congoU_S.png" alt="Eastern Congo keyboard layout (shift state)"></p>
    ...
    <table class="inputSequences">
        ...
        <tbody>a
            ...
            <tr>
                <td>;h</td><td></td><td>;H</td><td></td>
            </tr>
            <tr>
                <td>;n</td><td></td><td>;N</td><td></td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="inputSequences">
        ...
        <tbody>
            <tr>
                <td>&apos;</td><td>◌́</td><td>&apos;;E</td><td>Ɛ́</td><td>Combining mark (typed before a vowel and mMnNŋŊDrRsSzZ)</td>
            </tr>
            <tr>
                <td>`</td><td>◌̀</td><td>`;N</td><td>Ŋ̀</td><td>Combining mark (typed before a vowel and mMnNŋŊDrRsSzZ)</td>
            </tr>
            <tr>
