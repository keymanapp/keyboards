  ...
  <div id='osk' data-states='default shift'></div>
    ...
    <table class="inputSequences">
        ...
        <tbody>
            ...
            <tr>
                <td>&apos;&apos;</td><td>◌̋</td><td>&apos;&apos;&apos;;e</td><td>ɛ̋</td><td>Combining mark (typed before any of the following: aeiouɛəɨɪɩɔʉʊǝɵømnɲŋ)</td>
            </tr>
            <tr>
                <td>`</td><td>◌̀</td><td>`;N</td><td>Ŋ̀</td><td>Combining mark (typed before any vowel and dDmMnNŋŊrRsSzZ)</td>
            </tr>
            <tr>
                <td>``</td><td>◌̏</td><td>``;n</td><td>ŋ̏</td><td>Combining mark (typed before any of the following: aeiouɛəɨɪɩɔʉʊǝɵømnɲŋ)</td>
            </tr>
            <tr>
