...
*/
  $pagename = 'Korean KORDA Latin (SIL) Keyboard Help';
...
?>
   ...
   <div id='overview'>
    ...
    <p>The Korean KORDA Latin (SIL) keyboard creates hangeul syllables from latin letters each time you press <kbd>Spacebar</kbd>.</p>
  ...
  <div id='layout'>
   <h2>Keyboard Layout</h2>
    <h3 style="clear:left">Korean KORDA Latin (SIL) Keyboard</h3>
    ...
    <h3 class='latin'>Korean KORDA Latin (SIL) Keyboard</h3>
    <p>The Korean KORDA Latin (SIL) keyboard converts Latin letters into hangeul after you press <kbd>Spacebar</kbd>. As you type, Latin letters are shown. When you press <kbd>Spacebar</kbd>, the letters are converted into a hangeul syllable.</p>
