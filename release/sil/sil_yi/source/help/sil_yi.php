<?php
  ...
  table.inputSequences tr td.glyph {font-size: 1.7em;}
  table+table {margin-top: 3.0em;}
  .important {font-size: 1.2em;background-color: #D0E4F5;padding-top:1.2em;padding-bottom:1.2em;max-width:850px; }
  .centered {text-align: center; }
  p.centered+table {margin-top:2.0em; }
  .glyph.yi {font-family:'Microsoft Yi Baiti', 'Noto Sans Yi', NSimSun-18030, SimSun-18030, 'SIL Yi', Code2000; }
  table {table-layout: fixed; }
  td { text-align: center; margin-left: 0.04in; margin-right: 0.04in; margin-top: 0.06in; margin-bottom: 0in }
  td.western { font-family: sans-serif }
  td.cjk { font-family: "Nuosu SIL" }
  td.ctl { font-family: sans-serif }
  h1 { margin-left: 0.04in; margin-right: 0.04in }
  h1.cjk { font-family: "Microsoft YaHei" }
  h1.ctl { font-family: sans-serif }
  p { font-family: sans-serif; margin-left: 0.04in; margin-right: 0.04in; margin-bottom: 0.08in }
  h2 { margin-left: 0.04in; margin-right: 0.04in }
  h2.western { font-family: Sans-serif }
  h2.cjk { font-family: Sans-serif }
  h2.ctl { font-family: "Lucida Sans" }
  th { margin-left: 0.04in; margin-right: 0.04in; margin-top: 0.04in; margin-bottom: 0.04in }
  th.western { font-family: sans-serif; font-size: 10pt }
  th.cjk { font-family: sans-serif }
  th.ctl { font-family: sans-serif }
  kbd.cjk { font-family: "NSimSun", monospace }
END;
  require_once('header.php');
?>

  <p>Mobile and desktop keyboards type Nuosu Yi syllables, Yi radicals, and full-width punctuation in Unicode encoding, viewable with a font such as <a href="https://software.sil.org/nuosu/">Nuosu SIL</a>.</p>
  <h2>Mobile</h2>
  <p>On mobile platforms, choose a Yi Pinyin consonant then vowel+tone. Syllables that begin with a vowel have null (Ø) consonant. This method lets you type any Yi syllable character with just two keystrokes.</p>
  <table>
    <tr>
      <th>Consonant</th>
      <th>Vowel+Tone</th>
  ...
  <p>In the default layer and the numeric layer, the backspace key removes the last code point that was typed. In other layers, the backspace key returns to the default layer without typing a character.</p>
  <p>To type space, touch the <b>#.?</b> key to go to the numeric layer, then type the key in the upper left corner. (It is labeled "sil_yi" because Keyman automatically puts the keyboard name on the space bar.)</p>
  <p>To type a Yi radical, long press the <b>#.?</b> key, then touch a Yi radical. To type a variant form of a radical, long press the base form of the radical.</p>
  <h2>Desktop</h2>
  <p>Type Latin letters to spell a syllable in Yi Pinyin, then space to enter the syllable character. Type "w" + space to enter the syllable iteration mark ꀕ. To type a Yi radical, append "b" (for ꀨ) to its Yi Pinyin name.</p>
  <table>
    <tr>
      <th>Type Yi Pinyin letters</th>
      <th>Display</th>
    </tr>
    <tr>
      <td>i + e + t + space</td>
...
<p>Note the keystrokes at the bottom of the list for typing book title brackets and left and right Chinese quotation marks. For instance, typing two left angle brackets in a row will produce a Chinese left double book title bracket. Typing a backslash produces a Chinese dunhao. Typing two left single quotes in a row produces a full-width left double quotation mark.</p>
<table>
 <thead>
  <tr>
   <th>Keys</th>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>Decimal point (full stop; period)</td>
  </tr>
  <tr>
   <td>..</td>
  ...
  <tr>
   ...
   <td>Middle dot in foreign names</td>
  </tr>
  <tr>
   <td>\</td>
   <td class="glyph yi" title="U+3001 IDEOGRAPHIC COMMA">&#x3001;</td>
   <td>Ideographic comma (dunhao)</td>
  </tr>
  <tr>
   <td>,</td>
   <td class="glyph yi" title="U+FF0C FULLWIDTH COMMA">&#xff0c;</td>
  ...
  <tr>
   <td>&gt;</td>
   <td class="glyph yi" title="U+3009 RIGHT ANGLE BRACKET">&#x3009;</td>
  ...
  <tr>
   <td>`</td>
   <td class="glyph yi" title="U+2018 LEFT SINGLE QUOTATION MARK">&#x2018;</td>
   <td>Left single quotation mark</td>
  </tr>
  <tr>
   <td>'</td>
   <td class="glyph yi" title="U+2019 RIGHT SINGLE QUOTATION MARK">&#x2019;</td>
  ...
  <tr>
   <td>-</td>
   <td class="glyph yi" title="U+FF0D FULLWIDTH HYPHEN-MINUS">&#xff0d;</td>
   <td>Fullwidth hyphen-minus</td>
  </tr>
  <tr>
   <td>--</td>
   <td class="glyph yi" title="U+2013 EN DASH">&#x2013;</td>
   <td>Joining dash (en dash)</td>
  </tr>
  <tr>
   <td>---</td>
   <td class="glyph yi" title="U+2014 EM DASH">&#x2014;</td>
   <td>Word breaking dash (em dash)</td>
  </tr>
  <tr>
   <td>~</td>
   <td class="glyph yi" title="U+007E TILDE">&#x007e;</td>
   <td>Tilde</td>
  </tr>
  <tr>
   <td>$</td>
   <td class="glyph yi" title="U+00A5 YEN SIGN">&#x00a5;</td>
   <td>Chinese Yuan symbol</td>
  </tr>
 </tbody>
</table>

<h2>Standard Yi Syllabary Table</h2>
...
<table id="yiRadicals">
 ...
 <tbody>
  <tr>
   <td>1</td>
   <td class="glyph yi" title="U+A490 YI RADICAL QOT">꒐</td>
   <td></td>
   <td>qotb</td>
  </tr>
  <tr>
   <td>2</td>
   <td class="glyph yi" title="U+A491 YI RADICAL LI">꒑</td>
   <td></td>
   <td>lib</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A492 YI RADICAL KIT">꒒</td>
   <td>kitb</td>
  </tr>
  <tr>
   <td>3</td>
   <td class="glyph yi" title="U+A493 YI RADICAL NYIP">꒓</td>
   <td></td>
   <td>nyipb</td>
  </tr>
  <tr>
   <td>4</td>
   <td class="glyph yi" title="U+A494 YI RADICAL CYP">꒔</td>
   <td></td>
   <td>cypb</td>
  </tr>
  <tr>
   <td>5</td>
   <td class="glyph yi" title="U+A495 YI RADICAL SSI">꒕</td>
   <td></td>
   <td>ssib</td>
  </tr>
  <tr>
   <td>6</td>
   <td class="glyph yi" title="U+A496 YI RADICAL GGOP">꒖</td>
   <td></td>
   <td>ggopb</td>
  </tr>
  <tr>
   <td>7</td>
   <td class="glyph yi" title="U+A497 YI RADICAL GEP">꒗</td>
   <td></td>
   <td>gepb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A498 YI RADICAL MI">꒘</td>
   <td>mib</td>
  </tr>
  <tr>
   <td>8</td>
   <td class="glyph yi" title="U+A499 YI RADICAL HXIT">꒙</td>
   <td></td>
   <td>hxitb</td>
  </tr>
  <tr>
   <td>9</td>
   <td class="glyph yi" title="U+A49A YI RADICAL LYR">꒚</td>
   <td></td>
   <td>lyrb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A49B YI RADICAL BBUT">꒛</td>
   <td>bbutb</td>
  </tr>
  <tr>
   <td>10</td>
   <td class="glyph yi" title="U+A49C YI RADICAL MOP">꒜</td>
   <td></td>
   <td>mopb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A49D YI RADICAL YO">꒝</td>
   <td>yob</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A49E YI RADICAL PUT">꒞</td>
   <td>putb</td>
  </tr>
  <tr>
   <td>11</td>
   <td class="glyph yi" title="U+A49F YI RADICAL HXUO">꒟</td>
   <td></td>
   <td>hxuob</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4A0 YI RADICAL TAT">꒠</td>
   <td>tatb</td>
  </tr>
  <tr>
   <td>12</td>
   <td class="glyph yi" title="U+A4A1 YI RADICAL GA">꒡</td>
   <td></td>
   <td>gab</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4A2 YI RADICAL ZUP">꒢</td>
   <td>zupb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4A3 YI RADICAL CYT">꒣</td>
   <td>cytb</td>
  </tr>
  <tr>
   <td>13</td>
   <td class="glyph yi" title="U+A4A4 YI RADICAL DDUR">꒤</td>
   <td></td>
   <td>ddurb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4A5 YI RADICAL BUR">꒥</td>
   <td>burb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4A6 YI RADICAL GGUO">꒦</td>
   <td>gguob</td>
  </tr>
  <tr>
   <td>14</td>
   <td class="glyph yi" title="U+A4A7 YI RADICAL NYOP">꒧</td>
   <td></td>
   <td>nyopb</td>
  </tr>
  <tr>
   <td>15</td>
   <td class="glyph yi" title="U+A4A8 YI RADICAL TU">꒨</td>
   <td></td>
   <td>tub</td>
  </tr>
  <tr>
   <td>16</td>
   <td class="glyph yi" title="U+A4A9 YI RADICAL OP">꒩</td>
   <td></td>
   <td>opb</td>
  </tr>
  <tr>
   <td>17</td>
   <td class="glyph yi" title="U+A4AA YI RADICAL JJUT">꒪</td>
   <td></td>
   <td>jjutb</td>
  </tr>
  <tr>
  ...
  <tr>
   <td>18</td>
   <td class="glyph yi" title="U+A4AC YI RADICAL PYT">꒬</td>
   <td></td>
   <td>pytb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4AD YI RADICAL HMO">꒭</td>
   <td>hmob</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4AE YI RADICAL YIT">꒮</td>
   <td>yitb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4AF YI RADICAL VUR">꒯</td>
   <td>vurb</td>
  </tr>
  <tr>
   <td>19</td>
   <td class="glyph yi" title="U+A4B0 YI RADICAL SHY">꒰</td>
   <td></td>
   <td>shyb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4B1 YI RADICAL VEP">꒱</td>
   <td>vepb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4B2 YI RADICAL ZA">꒲</td>
   <td>zab</td>
  </tr>
  <tr>
   <td>20</td>
   <td class="glyph yi" title="U+A4B3 YI RADICAL JO">꒳</td>
   <td></td>
   <td>job</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4B4 YI RADICAL NZUP">꒴</td>
   <td>nzupb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4B5 YI RADICAL JJY">꒵</td>
   <td>jjyb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4B6 YI RADICAL GOT">꒶</td>
   <td>gotb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4B7 YI RADICAL JJIE">꒷</td>
   <td>jjieb</td>
  </tr>
  <tr>
   <td>21</td>
   <td class="glyph yi" title="U+A4B8 YI RADICAL WO">꒸</td>
   <td></td>
   <td>wob</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4B9 YI RADICAL DU">꒹</td>
   <td>dub</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4BA YI RADICAL SHUR">꒺</td>
   <td>shurb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4BB YI RADICAL LIE">꒻</td>
   <td>lieb</td>
  </tr>
  <tr>
   <td>22</td>
   <td class="glyph yi" title="U+A4BC YI RADICAL CY">꒼</td>
   <td></td>
   <td>cyb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4BD YI RADICAL CUOP">꒽</td>
   <td>cuopb</td>
  </tr>
  <tr>
   <td>23</td>
   <td class="glyph yi" title="U+A4BE YI RADICAL CIP">꒾</td>
   <td></td>
   <td>cipb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4BF YI RADICAL HXOP">꒿</td>
   <td>hxopb</td>
  </tr>
  <tr>
   <td>24</td>
   <td class="glyph yi" title="U+A4C0 YI RADICAL SHAT">꓀</td>
   <td></td>
   <td>shatb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4C1 YI RADICAL ZUR">꓁</td>
   <td>zurb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4C2 YI RADICAL SHOP">꓂</td>
   <td>shopb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4C3 YI RADICAL CHE">꓃</td>
   <td>cheb</td>
  </tr>
  <tr>
   <td>25</td>
   <td class="glyph yi" title="U+A4C4 YI RADICAL ZZIET">꓄</td>
   <td></td>
   <td>zzietb</td>
  </tr>
  <tr>
   <td></td>
   <td></td>
   <td class="glyph yi" title="U+A4C5 YI RADICAL NBIE">꓅</td>
   <td>nbieb</td>
  </tr>
  <tr>
   <td>26</td>
   <td class="glyph yi" title="U+A4C6 YI RADICAL KE">꓆</td>
   <td></td>
   <td>keb</td>
  </tr>
 </tbody>
