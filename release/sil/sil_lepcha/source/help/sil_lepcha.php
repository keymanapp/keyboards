...
<p>This keyboard is designed for typing Lepcha text. The keyboard is a phonetic keyboard. For example, to type LEPCHA LETTER KA, you would type the letter "k" on the keyboard. In some cases you will need to type two keystrokes. For example, to type LEPCHA LETTER KHA, you would type "kh". Visually, when you begin typing the sequence (k), you will first see LEPCHA LETTER KA (ᰀ), but once you add an "h" it will turn into KHA (ᰂ). </p>
