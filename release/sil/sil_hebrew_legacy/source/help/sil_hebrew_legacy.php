<?php
  $pagename = 'Hebrew Legacy (SIL) Keyboard Help';
  $pagetitle = 'Hebrew Legacy (SIL) Keyboard Help';
  $pagestyle = <<<END
...
<p>This keyboard is designed for Biblical Hebrew. It reverts the input behavior for <i>holam</i> and <i>holam haser</i> to an earlier version of the official 
<a href="https://keyman.com/keyboards/sil_hebrew">Hebrew (SIL)</a> keyboard.</p>
...
<h3><i>holam</i></h3>
    ...
    <table class="inputSequences">
        ...
        <tr>
            ...
            <th>
                <p>owa </i>(any vowel)</i></i></p>
            </th>
            <th>
                <p>o RALT = <i>(any cantillation)</i> w</p>
            </th>
        </tr>
        </thead>
        <tbody>
        <tr class="glyphs">
            ...
            <td>
                <p class="hebr" dir="rtl">ֹו</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">וֹ</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">וֹּ</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">וֹו</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">וֹּו</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">ֹוו</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">ֹוּ</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">ֹוַֹ</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">ֹ֑ו</p>
            </td>
        </tr>
        <tr>
            <td class="label">
            ...
            <td>
                <p><span style="color:red;">05B9</span> 05D5</p>
            </td>
            <td>
                <p>05D5 <span style="color:red;">05B9</span></p>
            </td>
            <td>
                <p>05D5 05BC <span style="color:red;">05B9</span></p>
            </td>
            <td>
                <p>05D5 <span style="color:red;">05B9</span> 05D5</p>
            </td>
            <td>
                <p>05D5 05BC <span style="color:red;">05B9</span> 05D5</p>
            </td>
            <td>
                <p><span style="color:red;">05B9</span> 05D5 05D5</p>
            </td>
            <td>
            ...
            <td>
                <p><span style="color:red;">05B9</span> 0591 05D5</p>
            </td>
        </tr>
        </tbody>
    </table>

<h3><i>holam haser</i></h3>
    <table class="inputSequences">
        <colgroup>
            <col width="85" />
            <col width="55" />
        ...
        <tr class="glyphs">
            ...
            <td>
                <p class="hebr" dir="rtl">ֺו</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">וֺ</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">וֺּ</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">וֺו</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">וֺּו</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">ֺוו</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">ֺוּ</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">ֺוַ</p>
            </td>
            <td>
                <p class="hebr" dir="rtl">ֺ֑ו</p>
            </td>
        </tr>
        <tr>
            <td class="label">
            ...
            <td>
                <p><span style="color:blue;">05BA</span> 05D5</p>
            </td>
            <td>
            ...
            <td>
                <p>05D5 <span style="color:blue;">05BA</span> 05D5</p>
            </td>
            <td>
                <p>05D5 05BC <span style="color:blue;">05BA</span> 05D5</p>
            </td>
            <td>
                <p><span style="color:blue;">05BA</span> 05D5 05D5</p>
            </td>
            <td>
                <p><span style="color:blue;">05BA</span> 05D5 05BC</p>
            </td>
            <td>
                <p><span style="color:blue;">05BA</span> 05D5 05B7</p>
            </td>
            <td>
                <p><span style="color:blue;">05BA</span> 0591 05D5</p>
            </td>
        </tr>
        </tbody>
    </table>
