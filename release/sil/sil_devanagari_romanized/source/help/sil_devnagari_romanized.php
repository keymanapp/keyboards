...
<?php
$pagename = 'SIL Devnagari Romanized Keyboard Help';
$pagetitle = $pagename;
$pagestyle=<<<END
...
Similar to desktop layout for most part, except for Alt-Ctrl. Symbols that required dead key combinations (especially independent nepali vowel letters) can be typed with their respective dependent vowels symbol.
