<?php
  ...
  @import url(//fonts.googleapis.com/earlyaccess/notosansvai.css);
    ...
    span.vai {font-size: 1.5em; font-family: Dukor, Ebrima, 'Noto Sans Vai', sans-serif; }
...
?>
  ...
  <h2>Introduction</h2>
  <p>This keyboard was developed for keyboarding the Vai Script. It is based on the old custom encoded keyboard, but it has been updated for Unicode. The majority of the keystrokes remain the same. (One significant difference is that an “x” is used instead of an “r” for the “o” forms). </p>

  <p>The SIL keyboard is designed to work with any Unicode Vai font.</p>
