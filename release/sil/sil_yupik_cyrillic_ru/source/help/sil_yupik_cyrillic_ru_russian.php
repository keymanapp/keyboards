...
<p>
    <b>Эскимосская клавиатура (русская раскладка)</b> позволяет пользователю печатать кириллическим шрифтом, используя раскладку, основанную на стандартной русской клавиатуре. Русская раскладка была изменена, чтобы предоставить доступ к дополнительным символам, необходимым для эскимосского языка. Клавиатура теперь доступна как для настольного компьютера, так и для сенсорного экрана.
</p>

<h2>Требования к шрифту</h2>

<p>
    Клавиатуру можно использовать с любым шрифтом, поддерживающим:
</p>
<ul>
    <li>блок Юникода кириллического алфавита (U+0400..U+04FF) и</li>
    <li>использование комбинирования диакритических знаков. (В эскимоской прописи используется макрон над некоторыми гласными.)</li>
</ul>
<p>
    Никакие шрифты не включены в этот пакет клавиатуры.
</p>

<h1>Раскладка клавиатуры для настольного компьютера</h1>

<p style="margin-bottom: 0.5em;">
    На следующих диаграммах клавиатуры любую клавишу, обозначенную синим символом, за которыми следует красный символ, можно нажать один раз, чтобы получить синий символ, или дважды, чтобы получить красный символ. Например, нажатие
</p>
...
<p style="margin-top: 3.5em;">
    один раз выведет “я”, нажатие на него во второй раз заменит “я” на “я̄”.
</p>


<h3 style="clear:left">Нижний регистр</h3>
...
<h3 style="clear:left">Верхний регистр</h3>
...
<h3 style="clear:left">Правая клавиша ALT</h3>
...
<h1>Раскладка клавиатуры для сенсорного экрана</h1>
<p>
    Раскладка клавиатуры для сенсорного экрана очень похожа на раскладку для настольного компьютера. Несколько символов ( ё Ё = + ъ Ъ \ / . , ) в углах  настольного компьютера пришлось переместить. Доступ к символам эскимосского языка можно получить либо двойным нажатием клавиши, либо длительным нажатием клавиши.
</p>
<p>
    На приведенной ниже диаграмме показаны как символы по умолчанию для каждой клавиши, так и любые символы длительного нажатия, связанные с клавишей. Каждая клавиша разделена на две части. Большой символ в нижнем поле является символом по умолчанию для клавиши — это то, что вы получите, если просто нажмете клавишу обычным способом. Маленькие символы в верхнем поле - это символы длительного нажатия, связанные с клавишей. Если клавиша не содержит символов длительного нажатия, верхний флажок отображается серым цветом. Например:
</p>
<div style="width: 30px; display: block; float: left;"> </div>
...
<div class="t_key t_comment" id="">
    <div class="t_textcommenttop"> ← символы длительного нажатия</div>
    <div class="t_textcommentbottom"> ← символ по умолчанию </div>
</div>
<br style="clear: left">
<br style="clear: left">
<div style="width: 30px; display: block; float: left;"> </div>
...
<div class="t_key t_comment" id="">
    <div class="t_textcommenttop"> ← нет символов длительного нажатия</div>
    <div class="t_textcommentbottom"> ← символ по умолчанию</div>
</div>
...
<h3>Алфавитные клавиши (строчные и заглавные буквы идентичны)</h3>
...
<h3>Список символов, доступных при длительном нажатии клавиш</h3>

<div class="long_narrow_table">
    <table>
        <tr>
            <td><b>клавиша</b></th>
            <td><b>символы длительного нажатия </b></td>
        </tr>
        <tr>
            <td>Й</td>
            <td>1</td>
...
<p>
    SIL International также опубликовала кириллическую эскимосскую клавиатуру, основанную на английской раскладки клавиатуры QWERTY. Она присваивает каждому символу кириллицы ключ ближайшего фонетически эквивалентного английского символа. Смотрите раскладку sil_yupik_cyrillic.
</p>
