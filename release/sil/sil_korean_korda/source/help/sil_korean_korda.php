<?php /*
  Name:        Korean KORDA
  Copyright:   2006-2011
  Description: This package contains the Korean KORDA Jamo keyboard and the Korean KORDA Latin keyboard. The Korean KORDA keyboards create Korean hangeul from jamo or latin letters each time you press Spacebar.
...
*/
  $pagename = 'Korean KORDA (SIL) Keyboard Help';
  $pagetitle = 'Korean KORDA (SIL) Keyboard Help';
...
<head>
  ...
  <title>Korean KORDA (SIL) Keyboards Help</title>
  <link rel="stylesheet" href="style.css" type="text/css" />
</head>
<body>
   <h1>Korean KORDA (SIL) Keyboards Help</h1>
   <div id='overview'>
    <h2>Overview</h2>
    <p>The Korean KORDA (SIL) keyboards are built to type Korean using the transliteration system KORDA (Korean Romanization for Data Application). KORDA is designed to make Latin-Korean transliteration easy, accurate, and computerizable. For more information on KORDA, see <a href='about_korda.pdf'>About KORDA</a>, included with this package in the Windows Start Menu.</p>
    <p>The Korean KORDA (SIL) keyboards create hangeul syllables from jamo or latin letters each time you press <kbd>Spacebar</kbd>.</p>
  ...
  <div id='layout'>
   <h2>Keyboard Layout</h2>
    <h3 style="clear:left">Korean KORDA (SIL) Keyboard</h3>
    ...
    <h3 class='latin'>Korean KORDA Latin Keyboard</h3>
    <p>The Korean KORDA Latin keyboard converts Latin letters into hangeul after you press <kbd>Spacebar</kbd>. As you type, Latin letters are shown. When you press <kbd>Spacebar</kbd>, the letters are converted into a hangeul syllable.</p>
    <p style='margin-left:40px'><b>Example:</b> type <span class='keys'>s</span><span class='keys'>a</span><span class='keys'>m</span> to see <span class='lang2'>s</span><span class='lang2'>a</span><span class='lang2'>m</span>. Press <kbd>Spacebar</kbd> to get <span class='lang2'>삼</span>.</p>
    <p>Pressing <kbd>Spacebar</kbd> twice will insert a space.</p>
    <p>The letters c, y, and w require you to type another key to get the right jamo for your hangeul syllable. The letter c needs h. The letters y and w need vowels.</p>
    ...
    <div class='consonants'>
        ...
        <table class='grid'>
            ...
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᄌ</td><td><span class='keys'>j</span></td>
            </tr>
            <tr style='text-align:center'>
    ...
    <div class='vowels'>
        ...
        <table class='grid'>
            ...
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅣ</td><td><span class='keys'>y</span>+<span class='keys'>a</span></td>
            </tr>
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅥ</td><td><span class='keys'>u</span></td>
            </tr>
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅧ</td><td><span class='keys'>y</span>+<span class='keys'>u</span></td>
            </tr>
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅩ</td><td><span class='keys'>o</span></td>
            </tr>
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅭ</td><td><span class='keys'>y</span>+<span class='keys'>o</span></td>
            </tr>
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅮ</td><td><span class='keys'>o</span>+<span class='keys'>o</span></td>
            </tr>
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅲ</td><td><span class='keys'>y</span>+<span class='keys'>o</span>+<span class='keys'>o</span></td>
            </tr>
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅳ</td><td><span class='keys'>e</span>+<span class='keys'>u</span></td>
            </tr>
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅵ</td><td><span class='keys'>i</span></td>
            </tr>
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅢ</td><td><span class='keys'>a</span>+<span class='keys'>e</span></td>
            </tr>
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅤ</td><td><span class='keys'>y</span>+<span class='keys'>a</span>+<span class='keys'>e</span></td>
            </tr>
            <tr style='text-align:center'>
            ...
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅱ</td><td><span class='keys'>w</span>+<span class='keys'>i</span></td>
            </tr>
            <tr style='text-align:center'>
