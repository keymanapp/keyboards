...
<p>The Tai Dam Typewriter (SIL) keyboard can be used with any font that supports the Tai Viet script. The Tai Heritage Pro font, which was used to create the keyboard layout shown below, is included for your convenience.</p>

<h2>Keyboard</h2>

<p>The Tai Dam Typewriter (SIL) keyboard has been designed for typing the Tai Viet script as it is used for writing the Tai Dam language. The layout is very similar to that of a pair of manual typewriters which were custom built for the Tai Dam community in the U.S. in the late 1970s, with some minor alterations to the top row and the square bracket keys on the right end of the row second from the top. This was done in order to include some of the punctuation characters that were not on the maual typewriters, but are often needed in an electronic environment. (E.g. the @ sign which is needed for email addresses.) Also, the vowel Mai Kang was added, even though it was not on the original typewriter layout, since some Tai Dam dialects use it.</p>
<p>This layout lacks the six aspirated consonants that are unique to Tai Dón, so it cannot be used for typing that language. It also lacks four consonants that were added to Unicode for use in loan words (Low Go, High Go, Low Ro, and High Ro).</p>
<h2>Layout</h2>
    
<p>If the charts below do not display the Tai Viet characters, install the Tai Heritage Pro font (included in this package).</p>
