<?php 
  $pagename = 'Syriac (Arabic layout) Keyboard Help';
  $pagetitle = 'Syriac (Arabic layout) Keyboard Help';
...
<p>The Syriac (Arabic layout) keyboard is based on standard Syriac keyboards.</p>
