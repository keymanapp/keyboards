...
KeymanWeb.KR(new Keyboard_eastern_pwo_karen());
}
function Keyboard_eastern_pwo_karen()
{
  var modCodes = keyman.osk.modifierCodes;
  var keyCodes = keyman.osk.keyCodes;

  this._v=(typeof keyman!="undefined"&&typeof keyman.version=="string")?parseInt(keyman.version,10):9;
  this.KI="Keyboard_eastern_pwo_karen";
  this.KN="eastern_pwo_karen";
  this.KMINVER="10.0";
  this.KV={F:' 1em "Arial"',K102:0};
  this.KV.KLS={
    "shift": ["","ဠ","ဎ","ဋ","$","%","^","ရ","*","(",")","_","+","","","","ဈ","ဝ","ၞ","ၟ","ဍ","ါဲ","ဥ","ၚ","ဴ","ဏ","ၯ","ၰ","|","","","","ဗ","ှ","ီ","္","ွ","ံ","ဲ","ဒ","ဓ","ဂ","\"","","","","","","","ဇ","ဌ","ဃ","ၠ","ယ","ဉ","ၜ","၊","။","?","","","","","",""],
