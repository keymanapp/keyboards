...
?>
  ...
  <p>
    <b>
      A simpler keyboard for Devanagari. देवनागरी के लिए एक सरलीकृत कुंजीपटल।
    </b>
  </p>
  <p>Barakunji is based on the clustering of syllables according to the area of the mouth used that is inherent to
  ...
  <p>Vowels and their diacritics play a central role in designating sounds to consonants in most Indian scripts. As
    such, the key for vowels is placed right in the center of the keyboard, for easier accessability.</p>
