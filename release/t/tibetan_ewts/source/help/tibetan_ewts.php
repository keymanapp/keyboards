...
*/
  ...
  $pagename = 'Tibetan EWTS Keyboard Help';
  $pagetitle = $pagename;
  $style = <<<END
/* 
===========
...
<p>Tibetan EWTS is based on the <a href='http://www.thlib.org/reference/transliteration/#!essay=/thl/ewts' target='_blank'>Extended Wylie Transliteration Scheme</a> (EWTS), an approach that avoids most <kbd>Shift</kbd>, <kbd>Alt</kbd>, and <kbd>Alt</kbd>+<kbd>Shift</kbd> combinations.</p> 
	...
	<ul>
		<li>Menus for extended Tibetan symbols</li>
	</ul>
	<h4>Fonts</h4>
...
<div id='osk' data-states='default shift alt'>
  ...
  <section id='details'  class='break'>
	...
	<section id='sym' class='break'>
		...
		<p>Tibetan EWTS includes menus to make it easier to type extended Tibetan symbols. To pull up a menu, type <kbd>\</kbd> and the name of the menu. Then select a menu item by typing the number of the item.</p>
