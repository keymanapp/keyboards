<?php 
  $pagename = 'Portuguese Basic Keyboard Help';
  $pagetitle = $pagename;
...
<p>
    This keyboard layout is designed for Portuguese.  It includes an on screen keyboard which can be viewed by clicking on the Keyman icon and selecting the On Screen Keyboard menu item. The keyboard layout follows the Windows 10 Portuguese layout.
</p>
