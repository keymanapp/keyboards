<?php 
  $pagename = 'Urdu Basic Keyboard Help';
  $pagetitle = 'Urdu Basic Keyboard Help';
...
<p>
The keyboard layout follows the Windows 10 Urdu Basic keyboard layout. This keyboard 
