<?php 
  $pagename = 'Czech Programmers Basic Keyboard Help';
  $pagetitle = $pagename;
...
<p>
    The keyboard layout follows the Windows 10 Czech Programmers Basic keybord layout.
</p>

<p>This keyboard makes use of "deadkeys" which are listed below:</p>

<p>´a will produce á (available on aAcCeEiIlLnNoOrRsSuUyYzZ).</p>
<p>˘c will produce č (available on cCdDeElLnNrRsStTzZ).</p>
<p>°u will produce ů (available on aAuU).</p>
