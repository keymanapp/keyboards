<?php 
  $pagename = 'Slovak (QWERTY) Basic Keyboard Help';
  $pagetitle = $pagename;
...
<p>
    This keyboard layout is designed for Slovak.  It includes an on screen keyboard which can be viewed by clicking on the Keyman icon and selecting the On Screen Keyboard menu item. The keyboard layout follows the Windows 10 Slovak (QWERTY) layout.
</p>
