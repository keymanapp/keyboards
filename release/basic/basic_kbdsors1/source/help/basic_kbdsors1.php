<?php 
  $pagename = 'Sorbian Standard Basic Keyboard Help';
  $pagetitle = $pagename;
...
<p>´c will produce ć (available on cClLnNoOrRsSzZ to become ćĆłŁńŃóÓŕŔśŚźŹ).</p>
<p>`a will produce á (available on aAeEiIoOuU).</p>
