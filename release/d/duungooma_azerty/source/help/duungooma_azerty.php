<?php
  $pagename = 'Duungooma Clavier (Azerty) Aide';
  $pagetitle = 'Duungooma Clavier (Azerty) Aide';
  $pagestyle = <<<END
...
<p>Le clavier duungooma est adapté pour les caractères spéciaux nécessaires. 
	The duun keyboard is suitable for special characters.</p>
