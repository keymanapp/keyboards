...
KeymanWeb.KR(new Keyboard_otoe_missouria());
}
function Keyboard_otoe_missouria()
{
  var modCodes = keyman.osk.modifierCodes;
  var keyCodes = keyman.osk.keyCodes;

  this._v=(typeof keyman!="undefined"&&typeof keyman.version=="string")?parseInt(keyman.version,10):9;
  this.KI="Keyboard_otoe_missouria";
  this.KN="Otoe-Missouria";
  this.KMINVER="10.0";
  this.KV={F:' 1em "Arial"',K102:0};
  this.KV.KLS={
    "shift": ["́","!","@","#","$","%","^","&","*","(",")","_","+","","","","Ą","W","E","R","T","Y","U","I","O","P","{","}","|","","","","A","S","D","Ð","G","H","J","K","Į",":","\"","","","","","","","Z","X","C","Ų","B","N","M","<",">","?","","","","","",""],
    "default": ["́","1","2","3","4","5","6","7","8","9","0","-","=","","","","ą","w","e","r","t","y","u","i","o","p","[","]","\\","","","","a","s","d","ð","g","h","j","k","į",";","'","","","","","","","z","x","c","ų","b","n","m",",",".","/","","","","","",""]
  };
