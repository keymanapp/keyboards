<?php 
  $pagename = 'Aramaic (Hebrew layout) Keyboard Help';
  $pagetitle = 'Aramaic (Hebrew layout) Keyboard Help';
...
<p>Aramaic (Hebrew layout) is designed for use with Aramaic, Syriac and related languages. The Aramaic (Hebrew layout) keyboard was originally created by Illan Gonen and is based on the Hebrew standard keyboard layout.</p>
