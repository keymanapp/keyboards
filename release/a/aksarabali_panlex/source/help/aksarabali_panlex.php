...
<ul>
    ...
    <li>The most common modifiers are Shift, Ctrl, and Ctrl-Shift. For example, [B] [E] types ⟨ᬩᭂ⟩, [B] [Shift-E] types ⟨ᬩᬾ⟩, and [Ctrl-Shift-E] types ⟨ᬏ⟩; [S] types ⟨ᬲ⟩ and [S] [Ctrl-'] types ⟨ᬰ⟩.</li>
</ul>
...
<ul>
    ...
    <li>[Ctrl-/] types ZWNJ (zero-width non-joiner). This may be used to prevent certain ligatures. For example, [L] [E] [Ctrl-A] types ⟨ᬎ⟩, while [L] [E] [Ctrl-/] [Ctrl-A] types ⟨ᬍ‌ᬵ⟩.
