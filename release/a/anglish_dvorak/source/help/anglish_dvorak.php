<?php
    $pagename = "Ænglish Dvorak Keyboard Help";
    $pagetitle = $pagename;
    require_once('header.php');
?>

<p>
    Ænglish Keyboard for Writing Old English with Ease in Everyday Conversations.
</p>
...
<div id='osk' data-states='default shift'>
        ...
        <ul><strong>Ȝ/ȝ</strong> (called: <i>Yogh</i>) is pronounced "g" in "goat", and "y" in "year". Also, comes from the Rune Letter, and later converted into modern day "G".</ul>
        <ul><strong>Ƿ/ƿ</strong> (called: <i>Wynn</i>) is pronounced "w" as in "water". No, it is not "P", this one is slightly stretch downwards from the middle. This is also from the Runic Letter, and later changed into "W", after the printing press and Modern Standardization.</ul>
        <ul><strong>Þ/þ</strong> (called: <i>Thorn</i>) is the unvoiced "th" sound in "thing", "thought", etc. This is the Old Runic Letter commonly seen in "Þe Olde" on the old inn signs. Along, with "eth" it was changed to "th", because the Printing Press, brought from Europe, didn't have this Letter.</ul>
        <h4>Alphabets in Modern English, but Pronounced Differently</h4>
        <ul><strong>C/c</strong> is pronounced like "k" in "crate", and also pronounced like "ch" as in "chair". No, it is never pronounced like "s", 'cause "s" is pronounce like "s". It is pronounce [ʧ] usually before or after a front vowel, [k] elsewhere.</ul>
...
<h4>List of Vowels</h4>
        ...
        <ul><strong>I/i</strong> could be long or short, and is pronounced like "ee" as in "see", and "i" as in "sit".</ul>
