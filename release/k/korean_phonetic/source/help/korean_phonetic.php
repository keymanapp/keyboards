<?php /*
  ...
  Copyright: 
  Description: The Korean Phonetic keyboard creates Korean hangeul from jamo each time you press Spacebar.

The Korean Phonetic keyboard is built to type Korean using the Phonetic transliteration system when possible. This layout is designed to make Latin-Korean transliteration 100% unambiguous.
...
This mnemonic keyboard is based on the pronunciation of Korean. For an alternative accurate transliteration system, use the Korean KORDA keyboards.
  Authors:     
*/
  $pagename = 'Korean Phonetic Keyboard Help';
  $pagetitle = 'Korean Phonetic Keyboard Help';
...
?>
  <link rel="stylesheet" href="style.css" type="text/css" />
   ...
   <div id='overview'>
    ...
    <p>The Korean Phonetic keyboard creates hangeul syllables from jamo each time you press <kbd>Spacebar</kbd>.</p>
  ...
  <div id='layout'>
   <h2>Keyboard Layout</h2>
    ...
    <p>The Korean Phonetic keyboard converts Korean jamo into hangeul after you press <kbd>Spacebar</kbd>. As you type, Korean jamo are shown.
    ...
    <div class='consonants'>
        ...
        <table class='grid'>
            ...
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᄅ</td><td><span class='keys'>r</span></td>
            </tr>
            <tr style='text-align:center'>
            ...
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᆼ</td><td><span class='keys'>q</span></td>
            </tr>
            <tr style='text-align:center'>
    ...
    <div class='vowels'>
        ...
        <table class='grid'>
            ...
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅧ</td><td><span class='keys'>z</span></td>
            </tr>
            <tr style='text-align:center'>
            ...
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅨ</td><td><span class='keys'>E</span></td>
            </tr>
            <tr style='text-align:center'>
            ...
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅯ</td><td><span class='keys'>u</span>+<span class='keys'>v</span></td>
            </tr>
            <tr style='text-align:center'>
                <td class='lang2' style='font-size:24pt'>ᅰ</td><td><span class='keys'>u</span>+<span class='keys'>e</span></td>
            </tr>
            <tr style='text-align:center'>
