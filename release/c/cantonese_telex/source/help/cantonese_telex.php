...
<p>粵語國語字通用版本集合咗各種粵語口音嘅特點，形成咗一種能夠體現並且描述各種粵語口音嘅粵語表音文字，又減低咗同音字現象嘅影響，為唔同地區唔同口音嘅粵語使用者提供咗一種通用嘅書面文字</p> 
  <p> Oạt-Ngữ Quóc-Ngữ-Tị hệ yât chủng Lai-đinh hóa ké Oạt Ngữ mần-tị, ý tọi phát chiển Oạt Ngữ biểu-yâm mần-tị, suc đoản Oạt Mần học-tập thùng sư-slẻ sị-kan, tăng-khường Oạt-Ngữ sỉ-yụng-chẻ chi-kan ké ngình-tụi-lịch thùng tị-ngõ nhịnh-thùng</p>
 <p>Oạt-Ngữ Quóc-Ngữ-Tị Thung-Yụng Bản-Bổn tập-hập chỏ cóc-chủng Oạt-Ngữ hẩu-yâm ké đặc-điểm, yình-sình chỏ yât chủng nằng-cấu thể-yiện bính-xẻ miều-suất cóc-chủng Oạt-Ngữ hẩu-yâm ké Oạt-Ngữ biểu-yâm mần-tị, ựu kảm-đê chỏ thùng-yâm-xì ké yỉnh-hưởng, vỵ m̀ thùng đỵ-khư m̀ thùng hẩu-yâm ké Oạt-Ngữ sỉ-yụng-chẻ thề-cung chỏ yât chủng thung-yụng ké sư-miện mần-tị</p>p>
...
<p>Chữ Quốc Ngữ tiếng Quảng Đông thông dụng đã tổng hợp đặc trưng của các loại giọng của tiếng Quảng, hình thành một chữ viết biểu âm có thể thể hiện và mô tả các loại giọng của tiếng Quảng, cũng bớt ảnh hưởng của hiện tượng từ đồng âm, cho những người nói các giọng của tiếng Quảng Đông ở khắp nơi một hệ thống chữ viết thung yụng </p>
 ...
 <p>廣州音入面唔再分別嘅 ch（知）同t（精）韻首、tr（持）同x（青）韻首、s（詩）同sl（思）韻首依然喺通用版本入面得到體現</p>
 <p>The "ch" and "t" consonants pair, "tr" and "x" consonants pair, "s" and "sl" consonants pair which are not differed in Hong Kong and Canton city accent, are still presented in universal version.</p>
 ...
 <p>如果一個字嘅南寧音版本嘅韻腹係"ư", 喺廣州音或者台山話入面讀"cui/kui" "khui" "hui" "ngui" "slui" "xui" "tui" "nui" "lui"，咁呢啲字嘅通用版正寫係"cư/kư" "khư" "hư" "ngư" "slư" "xư" "tư" "nư" "lư"</p>
 <p>If a character's vowel is "ư" in Namning accent, and the character is pronounced "cui/kui" "khui" "hui" "ngui" "slui" "xui" "tui" "nui" "lui" in Canton city and Hong Kong accent or Hoisan accent, then the character should be spelled as "cư/kư" "khư" "hư" "ngư" "slư" "xư" "tư" "nư" "lư" in the universal version</p>
...
<p>tone rules quy tắc thanh điệu 音調規則</p>
 <p> 對應粵拼嘅第一聲唔使打，第二聲打r，第三聲打s，第四聲打f，第五聲打x，第六聲打j </p>p>
...
<p>如何逆虜來侵犯</p> 
<p>Nhừ Hò Ngịch Lỗ Lòi Xâm Phạn</p>
<p>汝等行看取敗虛</p> 
<p>Nhữ Đẳng Hành Hón Xử Bại Hư</p>
