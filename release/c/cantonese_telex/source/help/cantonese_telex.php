...
<p>粵語國語字通用版本集合咗各種粵語口音嘅特點，形成咗一種能夠體現並且描述各種粵語口音嘅粵語表音文字，又減低咗同音字現象嘅影響，為唔同地區唔同口音嘅粵語使用者提供咗一種通用嘅書面文字<p> 
 ...
 <p>Oạt-Ngữ Quóc-Ngữ-Tị Thung-Yụng Bản-Bổn tập-hập chỏ cóc-chủng Oạt-Ngữ hẩu-yâm ké đặc-điểm, yình-sình chỏ yât chủng nằng-cấu thể-yiện bính-xẻ miều-sút cóc-chủng Oạt-Ngữ hẩu-yâm ké Oạt-Ngữ biểu-yâm mần-tị, ựu kảm-đê chỏ thùng-yâm-xì ké yỉnh-hưởng, vỵ m̀ thùng đỵ-khư m̀ thùng hẩu-yâm ké Oạt-Ngữ sỉ-yụng-chẻ thề-cung chỏ yất chủng thung-yụng ké sư-miện mần-tị
...
<p>Chữ Quốc Ngữ tiếng Quảng Đông thông dụng đã tổng hợp đặc trưng của các loại giọng của tiếng Quảng, hình thành một chữ viết biểu âm có thể thể hiện và mô tả các loại giọng của tiếng Quảng, cũng bớt ảnh hưởng của hiện tượng từ đồng âm, cho những người nói các giọng của tiếng Quảng Đông ở khắp nơi một hệ thống chữ viết thung yụng <p>
 ...
 <p>喺廣州音或者台山話入面讀"cui/kui" "khui" "hui" "ngui"嘅音寫成"cư/kư" "khư" "hư" "ngư"</p>
 ...
 <p>ê同ay用嚟表示一於嘅發音，ê用嚟拼寫漢字詞源嘅字同有明確嘅詞源喺古音入面讀呢個韻腹嘅詞語，ay用嚟拼寫少部分嘅非漢字嘅詞語或者係漢字但係係由唔規則嘅音變產生出呢個讀音嘅字，譬如話「嚟lày」「睇thảy」「咪may」「咪mạy」「米may」「呢nay」「揮phay」「僞ngạy」「魏ngày」「危ngày」「矮ảy」「哎áy」「曳yay」「喺hảy」「使sảy」「费pháy」「沸pháy」</p>
 ...
 <p>y同ơi用嚟表示一於嘅發音，y用嚟拼寫有明確嘅詞源讀呢個韻腹嘅漢越詞或者純越詞，ơi用嚟拼寫冇韻首嘅單獨嘅音節譬如話「誒ợi」，同少部分嘅非漢字嘅詞語或者係漢字但係由不規則音變產生出嘅讀音，譬如話「嚟lời」，同用嚟表示外來語入面嘅呢個韻腹，譬如話「士多啤梨sị-đo-be-lởi」</p>
