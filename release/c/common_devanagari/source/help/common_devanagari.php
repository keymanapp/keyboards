...
<body>
 ...
 <table class="inputSequences">
    ...
    <h3>Numbers</h3> 
	<p>Numbers with backtick will get Devanagari numbers Eg: <kbd>1</kbd><kbd>`</kbd> will get <samp>१</samp> </P>
	

	
	<h3>Virama</h3>
	<p> <kbd>X</kbd> is used as virama Eg: <kbd>n</kbd> <kbd>X</kbd><kbd>m</kbd> will generate <samp>न्‌म</samp></p>
