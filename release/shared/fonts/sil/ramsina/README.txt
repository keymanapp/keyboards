...
basic Unicode support. For Syriac text, your application must be able to
handle Right to Left text as well as the initial, medial, final forms of each
Syriac letter. You will also need some way of entering Unicode text into your 
document.
...
In Microsoft Word, you can type the USV (e.g., 0710), then select "0710",
